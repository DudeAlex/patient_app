...
- Multi-modal "Add Record" flow (photo with on-device retake checks, baseline document scanning with enhanced previews and clarity prompts, voice dictation, keyboard, file upload, Gmail label import)
