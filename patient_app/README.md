...
- Settings screen with Google sign-in, Drive backup/restore, and auto backup toggle (mobile — weekly cadence planned; currently resume-triggered after critical changes)
