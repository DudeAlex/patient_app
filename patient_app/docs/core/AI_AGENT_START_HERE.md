...
## Documentation rules for all agents
- Use docs/core and docs/modules as the primary source of truth.
- Do not create new docs outside docs/ without explicit reason.
- Prefer updating existing docs over adding new ones.
- Never modify `.kiro` files unless explicitly requested.
