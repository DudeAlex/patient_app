...
- `src/llm/models.js` catalogs default model ids (chat friendly Gemma-3n-E4B-it, reasoning Apriel-1.5-15B-Thinker, fallback, image) and resolves chat model with optional env override.
