...
- `src/llm/models.js` catalogs default model ids (chat friendly Gemma-3n-E4B-it, reasoning Apriel-1.5-15B-Thinker, supported fallback meta-llama/Llama-3-70b-chat-hf, image) and resolves chat model with optional env override.
